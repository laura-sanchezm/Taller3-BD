...
#client = MongoClient(os.environ["mongodb://ISIS2304B07202610:EV1tmIhMtKdf@157.253.236.88:8087"])
# TODO: conectarse al cluster Admonsis  
client = MongoClient("mongodb://ISIS2304B07202610:EV1tmIhMtKdf@157.253.236.88:8087")

#client = MongoClient("")
# TODO: conectarse a la base de datos Admonsis  
# db = client["ISIS*******"]
db = client["ISIS2304B07202610"]
